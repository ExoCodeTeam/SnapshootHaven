      ...
      <div className="links flex gap-[200px]">
        <h1
          className={`cursor-pointer text-[22px] ${
            activeLink === "Best Selling" ? "border-b-4 border-yellow-500" : ""
          }`}
        ...
        <h1
          className={`cursor-pointer text-[22px] ${
            activeLink === "New Arrivals" ? "border-b-4 border-yellow-500" : ""
          }`}
        ...
        <h1
          className={`cursor-pointer text-[22px] ${
            activeLink === "Top Rated" ? "border-b-4 border-yellow-500" : ""
          }`}
