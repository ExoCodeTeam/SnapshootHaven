...
export default function Filters() {
    ...
    return (
        ...
        <div className="col-span-3 flex flex-col gap-[50px]" >
            <input type="text" placeholder="Searche ..." className=" h-[50px] w-full  p-[10px] text-[22px] placeholder:text-[36px] placeholder:text-[#303841] placeholder:text-opacity-30 
            placeholder:font-semibold focus:outline-none focus:border-[#F6C90E] focus:border-b-4 " />
